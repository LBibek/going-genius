  ...
  return (
    <div className="home-wrapper">
      ...
      <section className="hero-section">
        ...
        <div className="container hero-container animate-fade-in">
          ...
          <div className="hero-actions">
            <Link href="/auth/register" className="btn-hero primary-gradient">Create Free Account</Link>
          ...
          <div className="hero-stats">
            <div className="hero-stat">
              ...
              <span className="stat-label">Secure JWTs</span>
            </div>
            <div className="hero-stat">
              <span className="stat-value">OAuth 2.0</span>
              <span className="stat-label">Compliant API</span>
            </div>
            <div className="hero-stat">
              <span className="stat-value">&lt;50ms</span>
              <span className="stat-label">Auth Latency</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="growth-section">
        <div className="container">
          <div className="dev-content" style={{ direction: 'rtl' }}>
            <div className="dev-text" style={{ direction: 'ltr' }}>
            ...
            <div className="dev-code-preview" style={{ direction: 'ltr' }}>
...
window.location.href = authUrl;`}
  ...
  "theme": "golden-glass"
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .hero-title { font-size: clamp(2.5rem, 8vw, 4.5rem); font-weight: 900; line-height: 1.1; margin-bottom: 1.5rem; }
        .hero-subtitle { max-width: 700px; margin: 0 auto 3rem; color: var(--muted-light); font-size: 1.2rem; line-height: 1.6; }
        .hero-actions { display: flex; justify-content: center; gap: 1rem; }
        .btn-hero { padding: 1rem 2.5rem; border-radius: 14px; font-weight: 700; font-size: 1.1rem; transition: all 0.2s; display: inline-flex; align-items: center; }
        ...
        .hero-stats { display: flex; justify-content: center; gap: 4rem; margin-top: 5rem; }
        .hero-stat { display: flex; flex-direction: column; gap: 0.25rem; }
        .stat-value { font-size: 1.75rem; font-weight: 800; color: var(--primary); font-family: 'Outfit', sans-serif; }
        .stat-label { font-size: 0.8rem; color: var(--muted); text-transform: uppercase; letter-spacing: 0.05em; }

        .section-header { text-align: center; margin-bottom: 4rem; }
        .section-title { font-size: 2.5rem; font-weight: 800; margin-bottom: 1rem; }
        .section-subtitle { color: var(--muted-light); max-width: 600px; margin: 0 auto; font-size: 1.1rem; }
        ...
        .dev-section { padding: 8rem 0; background: rgba(0,0,0,0.2); }
        .dev-content { display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center; }
        .dev-list { list-style: none; display: flex; flex-direction: column; gap: 1rem; margin-top: 1.5rem; }
        .dev-list li { display: flex; align-items: center; gap: 0.75rem; color: var(--muted-light); }
        ...
        .code-body { padding: 1.5rem; font-family: 'JetBrains Mono', monospace; font-size: 0.9rem; color: #a5b4fc; background: var(--glass-heavy); }

        .main-footer { background: var(--background-alt); padding: 6rem 0 2rem; border-top: 1px solid var(--border); }
        .footer-container { display: grid; grid-template-columns: 2fr 3fr; gap: 4rem; margin-bottom: 4rem; }
        .footer-tagline { color: var(--muted); margin-top: 1.5rem; max-width: 300px; line-height: 1.6; }
        .footer-links-group { display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem; }
        .footer-col h4 { color: var(--foreground); margin-bottom: 1.5rem; font-size: 1rem; }
        .footer-col a { display: block; color: var(--muted); margin-bottom: 0.75rem; transition: color 0.2s; }
        .footer-col a:hover { color: var(--primary); }
        .footer-bottom { text-align: center; padding-top: 2rem; border-top: 1px solid rgba(150,150,150,0.1); color: var(--muted); font-size: 0.85rem; }

        .growth-section { padding: 6rem 0; background: radial-gradient(circle at bottom right, rgba(255, 177, 22, 0.05) 0%, transparent 50%); }
        .preview-mockup { width: 100%; max-width: 380px; padding: 0; overflow: hidden; border-radius: 16px; border: 1px solid rgba(150,150,150,0.1); box-shadow: 0 20px 50px rgba(0,0,0,0.2); }
        .mockup-header { background: var(--background-alt); padding: 0.75rem 1.25rem; display: flex; align-items: center; gap: 0.75rem; border-bottom: 1px solid rgba(150,150,150,0.1); font-size: 0.75rem; font-weight: 600; color: var(--muted-light); }
        .mockup-logo { width: 20px; height: 20px; background: var(--primary); border-radius: 4px; color: #000; display: flex; align-items: center; justify-content: center; font-size: 0.6rem; font-weight: 900; }
        .mockup-body { padding: 2rem; background: var(--glass-heavy); text-align: center; }
        .mockup-social-btns { display: flex; flex-direction: column; gap: 0.6rem; margin-bottom: 1.5rem; }
        .mockup-social { padding: 0.6rem; border: 1px solid rgba(150,150,150,0.1); border-radius: 8px; font-size: 0.8rem; font-weight: 600; color: var(--muted-light); }
        .mockup-divider { font-size: 0.7rem; color: var(--muted); margin: 1rem 0; position: relative; }
        .mockup-input { height: 38px; border: 1px solid rgba(150,150,150,0.1); border-radius: 8px; margin-bottom: 0.75rem; }
        .mockup-btn { height: 38px; background: var(--primary); border-radius: 8px; }

        .why-section { padding: 8rem 0; border-top: 1px solid var(--border); }
        .why-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 3rem; margin-top: 2rem; }
        .why-item { display: flex; flex-direction: column; gap: 1.5rem; }
        .why-number { font-size: 3rem; font-weight: 900; color: rgba(255, 177, 22, 0.1); line-height: 1; -webkit-text-stroke: 1px rgba(255, 177, 22, 0.3); }
        .why-content h3 { font-size: 1.25rem; margin-bottom: 0.75rem; color: var(--primary); }
        .why-content p { color: var(--muted-light); line-height: 1.6; font-size: 0.95rem; }
        ...
        .docs-tabs { display: flex; background: var(--glass); border-bottom: 1px solid var(--border); }
        .docs-tab { padding: 1rem 2rem; font-size: 0.85rem; font-weight: 600; color: var(--muted); cursor: pointer; }
        .docs-tab.active { color: var(--primary); border-bottom: 2px solid var(--primary); background: rgba(255, 177, 22, 0.05); }
        .docs-content { padding: 2rem; background: var(--background-alt); }
        .code-block { font-family: 'JetBrains Mono', monospace; font-size: 0.9rem; color: #a5b4fc; line-height: 1.7; overflow-x: auto; margin: 0; }
        .docs-footer { padding: 1.25rem 2rem; background: rgba(255,255,255,0.01); border-top: 1px solid var(--border); text-align: center; font-size: 0.9rem; color: var(--muted); }
